...
export class ClientSideRowModel<TData = unknown> {
  ...
  private stageContextExtras: Partial<RowModelStageContext> = {};
  ...
  setStageContextExtras(extras: Partial<RowModelStageContext>): void {
    this.stageContextExtras = extras;
  }
